...
This repository is a fork of the original [gs-messaging-rabbitmq](https://github.com/spring-guides/gs-messaging-rabbitmq) project. 
...
Explore the original Spring Guides at: [spring-guides](https://github.com/spring-guides).
